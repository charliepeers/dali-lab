// Initially I started to explore MongoDB with Mongoose schemas but decided to start with 
// a JSON file approach so that I could focus on learning the core API concepts first. 
// I may migrate to MongoDB later for better scalability and querying.
